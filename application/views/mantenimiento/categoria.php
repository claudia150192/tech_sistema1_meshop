			...
			<div class="row">
				<div class="col-md-6">
					<div class="panel">
						...
						<div class="panel-body">
							<table id="tbl_categoria" class="table table-striped table-bordered" cellspacing="0" width="100%"
							data-source="<?php echo base_url();?>mantenimiento/categoria/get_categorias_all/">
								<thead>
									<tr>
										<th>ID</th>
										<th>Descripción</th>
				...
				<div class="col-md-6">
					<div class="panel">
						...
						<!--===================================================-->
						<form class="form-horizontal" id="frm-registro" name="frm-registro" action-1="<?php echo base_url();?>mantenimiento/categoria/registrar"
						action-2="<?php echo base_url();?>mantenimiento/categoria/actualizar" 
						action-3="<?php echo base_url();?>mantenimiento/categoria/eliminar" >
							<div class="panel-body">
